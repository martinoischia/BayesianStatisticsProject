...
##### SIMULATION OF DATA TOY OF 8 MULTIVARIATE NORMAL, , 
...
for (i in means){
  ...
  for(it in 1:iterate){
    ...
    rbind(rmvnorm(1, i), rmvnorm(2, c(0, 3)), rmvnorm(2, c(0, 0)), rmvnorm(2, c(0, -3)), rmvnorm(2, c(-3, 0)), rmvnorm(2, c(3, 0)), rmvnorm(2, c(-3, 3)), rmvnorm(2, c(3, -3)))
