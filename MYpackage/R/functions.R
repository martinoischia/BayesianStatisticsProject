...
## To be run before running the examples
...
#' Closest partitions
#'
#' Finds the closest partitions to a given one under B/VI losses
...
#' VI or Binder loss according to Wade Gahramani algorithm
#'
